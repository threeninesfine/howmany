...
```{r assert_that, cache = FALSE, echo = FALSE}
...
tbl2b_formatted[, 5:11] <- apply( tbl2b[,5:11], 2, replace_values )
...
tbl2e_formatted[, 5:11] <- apply( tbl2e[,5:11], 2, replace_values )
...
.col.names.b2 = c("n", "Pr( Y )", "exp( bZ )", "exp( bX )", "adj", "unadj", "adj", "unadj", "adj", "unadj", "adj");
...
.col.names.b3 = c("n", "Pr( X )", "exp( bZ )", "exp( bX )", "adj", "unadj", "adj", "unadj", "adj", "unadj", "adj");
...
```{r batch-1-binY-binX_bias_examples, eval = FALSE, cache = TRUE, echo = FALSE, message = FALSE}
